...
import am2.common.bosses.ai.EntityAILightningRod;
import am2.common.bosses.ai.EntityAIStatic;
...
public class EntityLightningGuardian extends AM2Boss implements IAnimatedEntity{
	...
	protected void dropFewItems(boolean par1, int par2){
		...
		for (int j = 0; j < i; j++){
			this.entityDropItem(new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getKey(Affinity.LIGHTNING)), 0.0f);
		}
		i = rand.nextInt(10);
