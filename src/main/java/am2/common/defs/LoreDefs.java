...
public class LoreDefs {
	...
	private static void initItems() {
		...
		createItemEntry(ITEM_ESSENCE, "essence_arcane", new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.ARCANE)), 0);
		createItemEntry(ITEM_ESSENCE, "essence_earth", new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.EARTH)), 0);
		createItemEntry(ITEM_ESSENCE, "essence_air", new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.AIR)), 0);
		createItemEntry(ITEM_ESSENCE, "essence_fire", new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.FIRE)), 0);
		createItemEntry(ITEM_ESSENCE, "essence_water", new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.WATER)), 0);
		createItemEntry(ITEM_ESSENCE, "essence_nature", new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.NATURE)), 0);
		createItemEntry(ITEM_ESSENCE, "essence_ice", new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.ICE)), 0);
		createItemEntry(ITEM_ESSENCE, "essence_lightning", new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.LIGHTNING)), 0);
		createItemEntry(ITEM_ESSENCE, "essence_life", new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.LIFE)), 0);
		createItemEntry(ITEM_ESSENCE, "essence_ender", new ItemStack(ItemDefs.essence, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.ENDER)), 0);
		...
		createItemEntry(ITEM_AFFINITYTOME, "tome_none", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.NONE)), 1);
		createItemEntry(ITEM_AFFINITYTOME, "tome_arcane", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.ARCANE)), 0);
		createItemEntry(ITEM_AFFINITYTOME, "tome_earth", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.EARTH)), 0);
		createItemEntry(ITEM_AFFINITYTOME, "tome_air", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.AIR)), 0);
		createItemEntry(ITEM_AFFINITYTOME, "tome_fire", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.FIRE)), 0);
		createItemEntry(ITEM_AFFINITYTOME, "tome_water", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.WATER)), 0);
		createItemEntry(ITEM_AFFINITYTOME, "tome_nature", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.NATURE)), 0);
		createItemEntry(ITEM_AFFINITYTOME, "tome_ice", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.ICE)), 0);
		createItemEntry(ITEM_AFFINITYTOME, "tome_lightning", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.LIGHTNING)), 0);
		createItemEntry(ITEM_AFFINITYTOME, "tome_life", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.LIFE)), 0);
		createItemEntry(ITEM_AFFINITYTOME, "tome_ender", new ItemStack(ItemDefs.affinityTome, 1, GameRegistry.findRegistry(Affinity.class).getId(Affinity.ENDER)), 0);
		...
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_itemtransport", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorItemTransport.instance)), 2);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_interdiction", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorInterdiction.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_containment", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorContainment.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_packed_earth", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorPackedEarth.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_flatlands", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorFlatLands.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_progeny", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorProgeny.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_butchery", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorButchery.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_lunartides", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorMoonstoneAttractor.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_light", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorLight.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_felled_oak", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorFelledOak.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_gentle_rains", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorGentleRains.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_natures_bounty", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorNaturesBounty.instance)), 1);
		createItemEntry(ITEM_FLICKERFOCUS, "flicker_focus_fishing", new ItemStack(ItemDefs.flickerFocus, 1, GameRegistry.findRegistry(AbstractFlickerFunctionality.class).getId(FlickerOperatorFishing.instance)), 2);
